...
const ActionsService = require("../src/ActionsService");
...
describe("AssortmentService", () => {
  ...
  beforeEach(() => {
    ...
    let mockedCategoriesRepository = jest
      ...
      .mockImplementation(jest.fn());
    mockedCategoriesRepository.mockClear();

    let mockedActionsService = jest
      .spyOn(ActionsService.prototype, "addAction")
      .mockImplementation(jest.fn());
    mockedActionsService.mockClear();
  ...
  describe('should register user actions', () => {
    ...
    test('actionsService should be called properly when valid product added', () => {
      givenProductAddedSuccessfully();
      let command = new AddProductCommand(VALID_ASSORTMENT_ID, VALID_AMOUNT, VALID_NAME, VALID_PRICE, VALID_CATEGORIES, VALID_DESCRIPTION);
